                                            ...
                                            <div class="clr"></div>
                                                ...
                                                <div class="form" tagflag="true" isconspros="0" pid="975788">
                                                    <div class="item item01 titleEl" style="display:none;">
                                                        ...
                                                        <div class="tit">
                                                            <input autocomplete="off" id="title" n="title" style="width:340px;" type="text" class="title text area01" value="">
                                                            <div class="clr"></div>
                                                    ...
                                                    <div class="item"><span class="label"><em>*</em>评分：</span>
                                                        <div class="fl">
                                                            ...
                                                            <input type="hidden" n="commentStar">
                                                            <div class="clr"></div>
                                                        </div>
                                                    ...
                                                    <div class="item item01 xindeEl">
                                                        ...
                                                        <div class="cont">
                                                            <textarea n="" cols="" rows="" class="area area01">商品是否给力？快分享你的购买心得吧~</textarea>
                                                            <div class="clr"></div>
                                                    ...
                                                    <div class="item imgEl" id="imgContainer_3122336930_975788" style="position: relative;">
                                                        ...
                                                        <div class="fl">
                                                            <div class="upload-img-box">
                                                                <div class="img-list">
                                                                    <input type="hidden" n="imgs1" value="">
                                                                    <input type="hidden" n="imgs2" value="">
                                                                    <input type="hidden" n="imgs3" value="">
                                                                    <input type="hidden" n="imgs4" value="">
                                                                    <input type="hidden" n="imgs5" value="">
                                                                    <input type="hidden" n="imgs6" value="">
                                                                    <input type="hidden" n="imgs7" value="">
                                                                    <input type="hidden" n="imgs8" value="">
                                                                    <input type="hidden" n="imgs9" value="">
                                                                    <input type="hidden" n="imgs10" value="">
                                                    ...
                                                    <div class="isL item">
                                                        ...
                                                        <div class="fl">
                                                            <input id="seccode" acid="ZGgxODk8439" maxlength="7" type="text" autocomplete="off" class="text text02 itxt" n="">
