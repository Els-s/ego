...
<meta n="Keywords" content="java,好易购java" />
<meta n="description" content="在好易购中找到了29910件java的类似商品，其中包含了“图书”，“电子书”，“教育音像”，“骑行运动”等类型的java的商品。" />
                            ...
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" id="nickName" n="userVo.nickName" value="林中守望者">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl interest-list">
                                            ...
                                            <ul class="hobul">
                                                <li n="hobbyType" value="1">图书/音像/数字商品<s></s></li>
                                                <li n="hobbyType" value="2">家用电器<s></s></li>
                                                <li n="hobbyType" value="3">手机/数码<s></s></li>
                                                <li n="hobbyType" value="4">电脑/办公<s></s></li>
                                                <li n="hobbyType" value="5">家居/家具/家装/厨具<s></s></li>
                                                <li n="hobbyType" value="6">服饰内衣/珠宝首饰<s></s></li>
                                                <li n="hobbyType" value="7">个护化妆<s></s></li>
                                                <li n="hobbyType" value="8">鞋靴/箱包/钟表/奢侈品<s></s></li>
                                                <li n="hobbyType" value="9">运动健康<s></s></li>
                                                <li n="hobbyType" value="10">汽车用品<s></s></li>
                                                <li n="hobbyType" value="11">母婴/玩具乐器<s></s></li>
                                                <li n="hobbyType" value="12">食品饮料/保健食品<s></s></li>
                                                <li n="hobbyType" value="13">彩票/旅行/充值/票务<s></s></li>
                                            </ul>
                                        </div>
                                    </div>
									<div class="item">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt" maxlength="20" n="userVo.realName" id="realName" value="张志君">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <select n="userVo.province" class="selt mr5" id="province" value="2">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            <input type="text" class="itxt itxt1" n="userVo.address" id="address" value="上海徐汇区内环以内漕溪北路737弄2号楼3201室">
