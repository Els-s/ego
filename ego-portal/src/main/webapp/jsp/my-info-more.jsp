                            ...
                            <div class="user-set">
                                <div class="form">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="fl">
											<input type="radio" n="maritalStatus" value="0" checked="" style="display:none">
                                            <input type="radio" n="maritalStatus" class="jdradio" value="1"><label class="mr10">未婚</label>
                                            <input type="radio" n="maritalStatus" class="jdradio" value="2"><label class="mr10">已婚</label>
                                            <input type="radio" n="maritalStatus" class="jdradio" value="3"><label class="mr10">保密</label>
                                        </div>
                                    </div>
                                    <div class="item">
                                        <span class="label">月收入：</span>
                                        <div class="fl">
											<select class="selt" n="monthlyIncome" id="monthlyIncome"><option value="">请选择</option><option value="1">2000元以下</option><option value="2">2000-3999元</option><option value="3">4000-5999元</option><option value="4">6000-7999元</option><option value="5">8000元以上</option></select>
                                        </div>
                                    </div>
                                    <div class="item">
                                        ...
                                        <div class="fl">
                                            ...
                                            <div id="cidInputDIv" style="display:none">
                                                <input n="userVo.cid" id="cid" value="140109198709195835" maxlength="18" type="text" class="itxt">
